...
public class Turma {
	...
	public Matriculado professor;
	public Disciplina disciplina;
	boolean isAllocated = false;
	
	
	Turma(String nome, Disciplina disciplina, int qtdAlunos, int horario, int dia) {
		this.nome = nome;
	...
	Turma(String nome, Disciplina disciplina, int qtdAlunos, int horario, int dia, int horario2, int dia2, int horario3, int dia3) {
		this.nome = nome;
		this.disciplina = disciplina;
		this.horario.add(new Horario(dia,horario));
	...
	Turma(String nome, Disciplina disciplina, int qtdAlunos, int horario, int dia, int horario2, int dia2) {
		this.nome = nome;
		this.disciplina = disciplina;
		this.horario.add(new Horario(dia,horario));
		this.horario.add(new Horario(dia2,horario2));
	...
	Turma(String nome, int qtdAlunos, int horario, int dia, Matriculado professor, Disciplina disciplina) {
		this.nome = nome;
		this.qtdAlunos = qtdAlunos;
		this.horario.add(new Horario(dia,horario));
	...
	Turma(String nome, int qtdAlunos, int horario, int dia, int horario2, int dia2, int horario3, int dia3, Matriculado professor, Disciplina disciplina) {
		this.nome = nome;
		this.qtdAlunos = qtdAlunos;
		this.horario.add(new Horario(dia,horario));
		this.horario.add(new Horario(dia2,horario2));
	...
	Turma(String nome, int qtdAlunos, int horario, int dia, int horario2, int dia2, Matriculado professor, Disciplina disciplina) {
		this.nome = nome;
		this.qtdAlunos = qtdAlunos;
		this.horario.add(new Horario(dia,horario));
		this.horario.add(new Horario(dia2,horario2));
